...
import Portfolio18 from '../../assets/nike_clone.jpg'
    ...
    return (
        <section id= "works">
            ...
            <div className= "project">
                <a href= "https://oretigra.myshopify.com/"
                   target= "_blank"
                   rel= "noreferrer">
                    <img src= {Portfolio18} alt= "website" className= "worksImg"/>
                </a>
                <div className= "projectText">
                    <h2>Shopify Theme - Nike-clone Shopping Cart
                    ...
                    <div className= "links">
                        <a
                            href= "https://github.com/loretari/shopify-nike-clone"
                            target= "_blank"
                            rel= "noreferrer">
                            Code
                        ...
                        <a
                            href= "https://oretigra.myshopify.com/"
                            target= "_blank"
                            rel= "noreferrer">
                            Live Demo
